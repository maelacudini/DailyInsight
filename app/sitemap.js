...
export default async function sitemap() {
    ...
    const businessUrl = business.articles.map((post, index) => {
        return {
    ...
    const scienceUrl = science.articles.map((post, index) => {
        return {
    ...
    const technologyUrl = technology.articles.map((post, index) => {
        return {
